...
> README (inherited from Ablation H) covers one specific ablation's setup and
> results; it predates most of the later ablations (I–P), which live on
> other branches with their own docstrings.
